package com.blackflag.myhomeassistance.voiceRecognization;
...
import com.blackflag.myhomeassistance.Memory;
            ...
            if(resultCode == RESULT_OK) {
                ...
                if (!textMatchList.isEmpty()) {
                    ...
                    if (textMatchList.get(0).contains("search")) {
                        ...
                        if (textMatchList.contains("back"))
                        {
                        ...
                        if (textMatchList.contains("stop"))
                        {
